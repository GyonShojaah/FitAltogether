...
Nevertheless, useful constraints on the spectral shape of individual surface types may be obtained from the \edit{condition} that albedo should be between 0 and 1, depending on the trajectory of the planet in color space.  
...
%We find that observing at multiple wavelengths where surfaces albedo is close to 0 or 1 will provide better constraints. 
\end{abstract}
